(function () {
    ...
    var config = window.WaflowConfig || {};
    ...
    var botName = config.botName || 'Waflow Bot';
    ...
    if (!apiUrl) {
        console.error(
            '[Waflow Widget] ❌ apiUrl is missing from window.WaflowConfig'
        );
        return;
    }
    ...
    if (!chatbotId) {
        console.error(
            '[Waflow Widget] ❌ chatbotId is missing from window.WaflowConfig'
        );
        return;
    }
    ...
    if (window.__WAFLOW_WIDGET_LOADED__) {
        return;
    }

    window.__WAFLOW_WIDGET_LOADED__ = true;
    ...
    .waflow-widget-button:active {

      transform: scale(0.96);
    }


    .waflow-widget-button svg {
    ...
    .waflow-widget-panel.open {

      display: flex;

      animation:
        waflowSlideIn 0.18s ease-out forwards;
    }


    @keyframes waflowSlideIn {
    ...
    .waflow-widget-send:hover {

      opacity: 0.9;
    }


    .waflow-widget-send:disabled {
    ...
    .waflow-theme-glassmorphic .waflow-widget-button {
    ...
    .waflow-theme-glassmorphic .waflow-widget-button:hover {
      transform: scale(1.08) translateY(-2px) !important;
      box-shadow: 0 14px 35px rgba(0,0,0,0.25), 0 6px 16px rgba(0,0,0,0.12) !important;
    }

    .waflow-theme-glassmorphic .waflow-widget-button:active {
      transform: scale(0.94) !important;
    }

    .waflow-theme-glassmorphic .waflow-widget-button::before {
      content: none;
    }
    ...
    .waflow-theme-glassmorphic .waflow-widget-panel {
    ...
    .waflow-theme-glassmorphic .waflow-widget-panel::before {
      content: '';
      position: absolute;
      top: -50%;
      left: -50%;
      ...
      z-index: 0;
      pointer-events: none;
      animation: waflowGradientRotate 25s linear infinite;
    }

    @keyframes waflowGradientRotate {
      0% { transform: rotate(0deg); }
      100% { transform: rotate(360deg); }
    }

    .waflow-theme-glassmorphic .waflow-widget-header {
    ...
    .waflow-theme-glassmorphic .waflow-widget-brand {
      display: flex;
      flex-direction: column;
      align-items: center;
      gap: 8px;
    ...
    .waflow-theme-glassmorphic .waflow-widget-avatar {
      width: 52px;
      height: 52px;
      border-radius: 50%;
      ...
      justify-content: center;
      font-size: 24px;
      animation: waflowFloat 4s ease-in-out infinite;
    }

    @keyframes waflowFloat {
      0%, 100% { transform: translateY(0); }
      50% { transform: translateY(-4px); }
    }

    .waflow-theme-glassmorphic .waflow-widget-title {
    ...
    .waflow-theme-glassmorphic .waflow-widget-status {
    ...
    .waflow-theme-glassmorphic .waflow-widget-status::before {
      content: '';
      width: 6px;
      height: 6px;
      border-radius: 50%;
    ...
    .waflow-theme-glassmorphic .waflow-widget-close {
      position: absolute;
      top: 14px;
      right: 14px;
    ...
    .waflow-theme-glassmorphic .waflow-widget-close:hover {
      background: rgba(255, 255, 255, 0.6) !important;
      color: #1e293b !important;
    }

    .waflow-theme-glassmorphic .waflow-widget-messages {
      background: transparent !important;
      padding: 20px;
      z-index: 1;
    }

    .waflow-theme-glassmorphic .waflow-widget-message {
      border-radius: 16px;
      font-size: 13px;
      line-height: 1.5;
    ...
    .waflow-theme-glassmorphic .waflow-widget-message.bot {
      background: rgba(255, 255, 255, 0.65) !important;
      color: #1e293b !important;
      border-bottom-left-radius: 4px;
    }

    .waflow-theme-glassmorphic .waflow-widget-message.user {
    ...
    .waflow-theme-glassmorphic .waflow-widget-typing {
    ...
    .waflow-theme-glassmorphic .waflow-widget-input-area {
    ...
    .waflow-theme-glassmorphic .waflow-widget-input {
    ...
    .waflow-theme-glassmorphic .waflow-widget-input:focus {
      background: rgba(255, 255, 255, 0.75) !important;
      border-color: rgba(99, 102, 241, 0.4) !important;
      box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.08) !important;
    }

    .waflow-theme-glassmorphic .waflow-widget-send {
      background: rgba(255, 255, 255, 0.6) !important;
      border: 1px solid rgba(255, 255, 255, 0.5) !important;
    ...
    .waflow-theme-glassmorphic .waflow-widget-send:hover {
    ...
    .waflow-widget-lead-field {
      display: flex;
      flex-direction: column;
      gap: 5px;
    }
    .waflow-widget-lead-label {
      font-size: 11px;
      font-weight: 600;
      color: #64748b;
    ...
    .waflow-theme-glassmorphic .waflow-widget-lead-input {
      background: rgba(255, 255, 255, 0.5) !important;
      border: 1px solid rgba(255, 255, 255, 0.5) !important;
      color: #1e293b !important;
    }
    .waflow-widget-lead-input:focus {
      border-color: ${primaryColor} !important;
      box-shadow: 0 0 0 3px ${primaryColor}1a !important;
      background: rgba(255, 255, 255, 0.9) !important;
    }
    .waflow-widget-lead-submit {
      width: 100%;
      height: 40px;
      border: none;
      border-radius: 10px;
    ...
    .waflow-widget-lead-submit:hover {
      opacity: 0.95;
      transform: translateY(-1px);
    }
  `;
    ...
    root.className = 'waflow-widget' + (theme === 'glassmorphic' ? ' waflow-theme-glassmorphic' : '');
    ...
    function getBotIconHtml(size, color) {
        ...
        if (isUrl) {
            return '<img src="' + botIcon + '" alt="Avatar" style="width: ' + size + 'px; height: ' + size + 'px; border-radius: 50%; object-fit: cover;" onerror="this.hidden=true;" />';
        }
    ...
    <div class="waflow-widget-header">

      <div class="waflow-widget-brand">

        <div class="waflow-widget-avatar">
          ${avatarContent}
        </div>

        <div>

          <div class="waflow-widget-title">
            ${botName}
          </div>

          <div class="waflow-widget-status">
            ${subHeaderText}
          </div>
    ...
    <form class="waflow-widget-lead-form" style="display: none;"></form>

    <div
      class="waflow-widget-messages"
    ></div>


    <div
      class="waflow-widget-typing"
    >
      Typing…
    </div>
    ...
    <form
      class="waflow-widget-input-area"
    >

      <input
        class="waflow-widget-input"
        type="text"
        autocomplete="off"
  ...
  `;
    ...
    var leadCollectedKey = 'waflow_lead_collected_' + chatbotId;
    var leadDataKey = 'waflow_lead_data_' + chatbotId;
    ...
    function buildLeadForm() {
        ...
        var html = '<div style="margin-bottom: 12px; text-align: center;">' +
                   '<div class="waflow-widget-lead-title">Introduce yourself</div>' +
                   '<div class="waflow-widget-lead-subtitle">We would love to know you before starting the chat.</div>' +
                   '</div>';
        ...
        leadFields.forEach(function (field) {
            ...
            html += '<div class="waflow-widget-lead-field">' +
                    '<label class="waflow-widget-lead-label">' + label + '</label>' +
                    '<input class="waflow-widget-lead-input" type="' + type + '" name="' + field + '" placeholder="' + placeholder + '" required />' +
                    '</div>';
        });

        html += '<button type="submit" class="waflow-widget-lead-submit">Start Chat</button>';
    ...
    async function sendMessage(message) {
        ...
        var endpoint = apiUrl + '/api/v1/chatbot/widget/message';
    ...
    console.log(
        '[Waflow Widget] Loaded successfully'
    );
