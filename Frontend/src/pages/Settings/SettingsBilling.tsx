    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900 flex flex-col md:flex-row md:items-start justify-between gap-6">
        <div className="flex-1 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8 text-sm">
            ...
            <div>
              ...
              <span className={`inline-flex rounded-full px-2.5 py-1 text-xs font-bold ${user?.subscriptionStatus === 'active' || user?.subscriptionStatus === 'trial' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'}`}>
        ...
        <div className="flex flex-col gap-3 min-w-[200px]">
          {user?.subscriptionStatus === 'expired' || user?.subscriptionStatus === 'trial' ? (
                  ...
                  <tr key={record.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button 
                        ...
                        className="text-brand-500 hover:text-brand-600 hover:underline font-medium text-sm flex items-center justify-end gap-1.5"
                      >
