...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Waflow - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Waflow - React.js Tailwind CSS Admin Dashboard Template"
      />
